...
graph + layer1 + layer2 +xlab('Temperature') +
  ...
  ggtitle('Relationship between Confirmed Cases and Temperature')
...
graph + layer1 + layer2 +xlab('Temperature') +
  ...
  ggtitle('Relationship between Cases and Temperature')
...
* From the graphs, we could observe that the number of cases become extremely bigger when the temperature approaches around 12 Celsius. And it becomes stable when the temperature increases.  
